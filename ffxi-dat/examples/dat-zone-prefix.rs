//! Print the inferred zone prefix and a few MMB asset names, so we
//! can verify `infer_zone_prefix` returns sensibly for a zone.
...
fn main() {
    ...
    // Read first 6 placement IDs from MZB.

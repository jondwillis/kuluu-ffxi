//! Given a zone DAT, list every MMB asset and tell whether the MZB
//! placement table references it. Highlights "unplaced" MMBs — chunks
//! that contain geometry the runtime renderer never instances.
//!
//!   FFXI_DAT_PATH=... cargo run -p ffxi-dat --example dat-mmb-unplaced-survey -- <file_id>

//! End-to-end Phase 0 verifier. Resolves a `file_id` against a real
//! FFXI install and prints the location + first 64 bytes.
//!
//!   FFXI_DAT_PATH="/.../FINAL FANTASY XI" \
//!       cargo run -p ffxi-dat --example dat-resolve -- 100

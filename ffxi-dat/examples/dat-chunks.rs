//! Walk all chunks in a DAT file and print their FourCC + kind + size.
//! Validates the chunk walker against real bytes.
//!
//!   FFXI_DAT_PATH="/.../FINAL FANTASY XI" \
//!       cargo run -p ffxi-dat --example dat-chunks -- 100

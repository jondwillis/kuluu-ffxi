//! MMB decryption key tables. 256 bytes each, indexed by `data[5] ^ 0xf0`.
//!
//! Verbatim port of `Common/dat/KeyTables.cs` from
//! LandSandBoat/FFXI-NavMesh-Builder (GPL-3, © 2021 Xenonsmurf).

pub static KEY_TABLE: [u8; 256] = [

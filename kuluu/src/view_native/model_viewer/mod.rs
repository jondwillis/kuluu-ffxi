...
use bevy::prelude::*;
use kuluu_render::combat_stance::{enumerate_clips_for_skel, ModelViewerClipOverride, RestStance};
use kuluu_render::components::WorldEntity;
use kuluu_render::dat_vos2::{
...
pub fn run(args: ModelViewerArgs) -> Result<()> {
    ...
    app.init_resource::<SceneState>()
        ...
        .init_resource::<kuluu_render::combat_stance::AnimationBlends>()

use bevy::prelude::*;
use kuluu_render::components::CameraOccluder;
use kuluu_render::dat_mzb::{DrawDistance, MzbCollisionGeometry};
...
pub fn build_collision_bvh_system(
    ...
    scene_state: Res<kuluu_render::snapshot::SceneState>,
    query: Query<
...
mod bvh_tests {
    use super::*;
    use kuluu_render::dat_mzb::{build_collision_geometry, load_mzb_placed};

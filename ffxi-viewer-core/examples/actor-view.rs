//! Interactive grounding harness for the Phase 3 XIM-faithful character path.
//!
//! Usage:
//!   cargo run -p ffxi-viewer-core --example actor-view -- npc <file_id>
//!   cargo run -p ffxi-viewer-core --example actor-view -- pc <race> [equip_file_id ...]
//!
//! Default subject: a humanoid NPC. Orbit camera; keys 1..0 cycle pose state,
//! E toggles engaged. A Text node overlays the current clip + frame + state.

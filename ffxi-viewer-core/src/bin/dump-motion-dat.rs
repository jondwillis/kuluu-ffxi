//! Offline probe: dump all MO2 chunk names in a motion DAT.
//!
//! Combat-stance lookup (`combat_stance::battle_idle_anim_for_skel`)
//! assumes the motion DAT contains an MO2 chunk whose 3-char name
//! prefix is `idl`. This binary lets us *verify* that without
//! running the full client — just point it at a motion DAT id from
//! `vendor/lotus-ffxi/ffxi/entity/actor_data.cppm:23-30` and read
//! the dump.
//!
//! Usage:
//!   cargo run -p ffxi-viewer-core --bin dump-motion-dat -- 9672
//!
//! Example output:
//!   motion DAT 9672 (Hume M, battle anim 0):
//!     MO2 'idl0' (3 frames, speed=1.00)
//!     MO2 'wlk0' (10 frames, speed=1.00)
//!     ...
